...
$$(document).on('page:init', '.page[data-name="evidencia-guia"]', function (e,page) {
	...
	$$("#btn_emitir").click(function() {
		...
		//mainView.router.navigate('/PuntosGDE/'+zona_activa+'/'+id_gde_actual+'/'+opcion);
...
function emitir_guia(latitud,longitud){
          ...
          DATOS_cambiar_estado_gde_proveedores(id_gde_actual,estado, function(result1) {
            DATOS_cambiar_estado_gde_evidencia(id_gde_actual,estado, function(result2) {
