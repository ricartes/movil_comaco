...
function DATOS_guarda_gde_proveedor(GDE,callback){
	...
	this.db.transaction(function(tr) {
		...
		//INSERT INTO GDE (GDE_COD_DESPACHADOR, GDE_FECHA_EMISION, EMP_ID, GDE_COD_TRANSPORTISTA, GDE_NOMBRE_TRANSPORTISTA, GDE_RUT_CONDUCTOR, GDE_NOM_CONDUCTOR, GDE_PATENTE_CAMION, GDE_PATENTE_CARRO,  GDE_COORDENADA_X, GDE_COORDENADA_Y, GDE_COD_CLIENTE, GDE_NOMBRE_CLIENTE, GDE_DESTINO, GDE_COD_PROYECTO, GDE_NOMBRE_PREDIO, GDE_ROL_COMUNA, GDE_ROL, GDE_COD_PRODUCTO, GDE_NOMBRE_PRODUCTO, ID_UNICO_MOVIL, GDE_ESTADO_MOVIL, DocEntry, ENVIADO, GDE_COORDENADA_INICIAL_X, GDE_COORDENADA_INICIAL_Y, GDE_HORA_PUNTO_INICIO) VALUES(?, datetime('now','localtime'),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,datetime('now','localtime'))", [GDE.GDE_COD_DESPACHADOR, GDE.EMP_ID, GDE.GDE_COD_TRANSPORTISTA, GDE.GDE_NOMBRE_TRANSPORTISTA, GDE.GDE_RUT_CONDUCTOR, GDE.GDE_NOM_CONDUCTOR, GDE.GDE_PATENTE_CAMION, GDE.GDE_PATENTE_CARRO,  GDE.GDE_COORDENADA_X, GDE.GDE_COORDENADA_Y, GDE.GDE_COD_CLIENTE, GDE.GDE_NOMBRE_CLIENTE, GDE.GDE_DESTINO, GDE.GDE_COD_PROYECTO, GDE.GDE_NOMBRE_PREDIO, GDE.GDE_ROL_COMUNA, GDE.GDE_ROL, GDE.GDE_COD_PRODUCTO, GDE.GDE_NOMBRE_PRODUCTO, GDE.ID_UNICO_MOVIL, GDE.GDE_ESTADO_MOVIL, GDE.DocEntry, GDE.ENVIADO, GDE.GDE_COORDENADA_INICIAL_X, GDE.GDE_COORDENADA_INICIAL_Y

		tr.executeSql("INSERT INTO GDE (GDE_COD_DESPACHADOR, GDE_FECHA_EMISION, EMP_ID, GDE_COD_TRANSPORTISTA, GDE_NOMBRE_TRANSPORTISTA, GDE_RUT_CONDUCTOR, GDE_NOM_CONDUCTOR, GDE_PATENTE_CAMION, GDE_PATENTE_CARRO, GDE_COORDENADA_X, GDE_COORDENADA_Y, GDE_COD_CLIENTE, GDE_NOMBRE_CLIENTE, GDE_DESTINO, GDE_COD_PROYECTO, GDE_NOMBRE_PREDIO, GDE_ROL_COMUNA, GDE_ROL, GDE_COD_PRODUCTO, GDE_NOMBRE_PRODUCTO, ID_UNICO_MOVIL, GDE_ESTADO_MOVIL, DocEntry, ENVIADO, GDE_COORDENADA_INICIAL_X, GDE_COORDENADA_INICIAL_Y, GDE_HORA_PUNTO_INICIO) VALUES(?, datetime('now','localtime'),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,datetime('now','localtime'))", [GDE.GDE_COD_DESPACHADOR, GDE.EMP_ID, GDE.GDE_COD_TRANSPORTISTA, GDE.GDE_NOMBRE_TRANSPORTISTA, GDE.GDE_RUT_CONDUCTOR, GDE.GDE_NOM_CONDUCTOR, GDE.GDE_PATENTE_CAMION, GDE.GDE_PATENTE_CARRO, GDE.GDE_COORDENADA_X, GDE.GDE_COORDENADA_Y, GDE.GDE_COD_CLIENTE, GDE.GDE_NOMBRE_CLIENTE, GDE.GDE_DESTINO, GDE.GDE_COD_PROYECTO, GDE.GDE_NOMBRE_PREDIO, GDE.GDE_ROL_COMUNA, GDE.GDE_ROL, GDE.GDE_COD_PRODUCTO, GDE.GDE_NOMBRE_PRODUCTO, GDE.ID_UNICO_MOVIL, GDE.GDE_ESTADO_MOVIL, GDE.DocEntry, GDE.ENVIADO, GDE.GDE_COORDENADA_INICIAL_X, GDE.GDE_COORDENADA_INICIAL_Y], function(tr, rs) {
			typeof callback == "function" && callback(rs);
		});
	});
}
...
function DATOS_actualiza_gde_proveedor(GDE, rowid, callback){
	...
	//alert(GDE.GDE_Tipo_docto_ref);
	this.db.transaction(function(tr) {
		tr.executeSql("UPDATE GDE SET GDE_COD_DESPACHADOR=?, GDE_FECHA_EMISION=datetime('now','localtime'), EMP_ID=?, GDE_COD_TRANSPORTISTA=?, GDE_NOMBRE_TRANSPORTISTA=?, GDE_RUT_CONDUCTOR=?, GDE_NOM_CONDUCTOR=?, GDE_PATENTE_CAMION=?, GDE_PATENTE_CARRO=?, GDE_COORDENADA_X=?, GDE_COORDENADA_Y=?, GDE_COD_CLIENTE=?, GDE_NOMBRE_CLIENTE=?, GDE_DESTINO=?, GDE_COD_PROYECTO=?, GDE_NOMBRE_PREDIO=?, GDE_ROL_COMUNA=?, GDE_ROL=?, GDE_COD_PRODUCTO=?, GDE_NOMBRE_PRODUCTO=?, DocEntry=?, GDE_PATENTE_EX=?  WHERE ROWID=?", [GDE.GDE_COD_DESPACHADOR,GDE.EMP_ID, GDE.GDE_COD_TRANSPORTISTA, GDE.GDE_NOMBRE_TRANSPORTISTA, GDE.GDE_RUT_CONDUCTOR, GDE.GDE_NOM_CONDUCTOR, GDE.GDE_PATENTE_CAMION, GDE.GDE_PATENTE_CARRO, GDE.GDE_COORDENADA_X, GDE.GDE_COORDENADA_Y, GDE.GDE_COD_CLIENTE, GDE.GDE_NOMBRE_CLIENTE, GDE.GDE_DESTINO, GDE.GDE_COD_PROYECTO, GDE.GDE_NOMBRE_PREDIO, GDE.GDE_ROL_COMUNA, GDE.GDE_ROL, GDE.GDE_COD_PRODUCTO, GDE.GDE_NOMBRE_PRODUCTO, GDE.DocEntry, GDE.GDE_PATENTE_EX, rowid], function(tr, rs) {
			typeof callback == "function" && callback(rs);
		});
	});
}
...
function DATOS_guarda_gde_proveedor_vuelta(GDE,callback){
	...
	//alert(GDE.GDE_Tipo_docto_ref);
	this.db.transaction(function(tr) {
		tr.executeSql("INSERT INTO GDE (GDE_COD_DESPACHADOR,GDE_FECHA_EMISION, EMP_ID, GDE_COD_TRANSPORTISTA,GDE_NOMBRE_TRANSPORTISTA, GDE_RUT_CONDUCTOR, GDE_NOM_CONDUCTOR, GDE_PATENTE_CAMION, GDE_PATENTE_CARRO, GDE_COMENTARIO, GDE_GUIA_PROVEEDOR, GDE_VOLUMEN_PROVEEDOR, GDE_COORDENADA_X, GDE_COORDENADA_Y, GDE_COD_CLIENTE, GDE_NOMBRE_CLIENTE, GDE_DESTINO, GDE_COD_PROYECTO, GDE_NOMBRE_PREDIO, GDE_ROL_COMUNA, GDE_ROL, GDE_COD_PRODUCTO, GDE_NOMBRE_PRODUCTO, ID_UNICO_MOVIL, GDE_ESTADO_MOVIL, DocEntry, ENVIADO, GDE_COORDENADA_INICIAL_X, GDE_COORDENADA_INICIAL_Y, GDE_COORDENADA_FINAL_X, GDE_COORDENADA_FINAL_Y, GDE_HORA_PUNTO_INICIO, GDE_HORA_PUNTO_FINAL, GDE_PATENTE_EX) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [GDE.GDE_COD_DESPACHADOR, GDE.GDE_FECHA_EMISION, GDE.EMP_ID,GDE.GDE_COD_TRANSPORTISTA,GDE.GDE_NOMBRE_TRANSPORTISTA, GDE.GDE_RUT_CONDUCTOR, GDE.GDE_NOM_CONDUCTOR, GDE.GDE_PATENTE_CAMION, GDE.GDE_PATENTE_CARRO, GDE.GDE_COMENTARIO, GDE.GDE_GUIA_PROVEEDOR, GDE.GDE_VOLUMEN_PROVEEDOR, GDE.GDE_COORDENADA_X, GDE.GDE_COORDENADA_Y, GDE.GDE_COD_CLIENTE, GDE.GDE_NOMBRE_CLIENTE, GDE.GDE_DESTINO, GDE.GDE_COD_PROYECTO, GDE.GDE_NOMBRE_PREDIO, GDE.GDE_ROL_COMUNA, GDE.GDE_ROL, GDE.GDE_COD_PRODUCTO, GDE.GDE_NOMBRE_PRODUCTO, GDE.ID_UNICO_MOVIL, GDE.GDE_ESTADO_MOVIL, GDE.DocEntry, GDE.ENVIADO, GDE.GDE_COORDENADA_INICIAL_X, GDE.GDE_COORDENADA_INICIAL_Y, GDE.GDE_COORDENADA_FINAL_X, GDE.GDE_COORDENADA_FINAL_Y, GDE.GDE_HORA_PUNTO_INICIO, GDE.GDE_HORA_PUNTO_FINAL, GDE.GDE_PATENTE_EX], function(tr, rs) {
			typeof callback == "function" && callback(rs);
		});
	});
}
...
function DATOS_seleccionar_gde_proveedor_por_estado_lista_PRUEBA(estado,fecha_inicial,fecha_final,numero_guia,callback){
	...
	this.db = window.sqlitePlugin.openDatabase({name: "bd.db", location: 'default', androidDatabaseImplementation: 2});
		this.db.transaction(function(tr) {
			tr.executeSql("SELECT g.*, g.rowid,  strftime('%d-%m-%Y %H:%M', g.GDE_FECHA_EMISION) AS GDE_FECHA_FORMAT FROM GDE g WHERE (g.ENVIADO=? or ?=-1) AND GDE_COD_DESPACHADOR=? AND ( (strftime('%Y-%m-%d', g.GDE_FECHA_EMISION) BETWEEN ? AND ?) OR (?='' AND ?='' )  )", [estado,estado,Obtener_dato_local("rut_activo"),fecha_inicial,fecha_final,fecha_inicial,fecha_final], function(tr, rs) {
				var n = rs.rows.length;
				if(n==0){
					typeof callback == "function" && callback(-1);
				}
