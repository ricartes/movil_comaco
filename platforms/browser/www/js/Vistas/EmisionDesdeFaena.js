...
function recargar_combo_transportista(){
  $$("#combo_transporte").val(gde_actual.GDE_PATENTE_CAMION);
    ...
    /* var seleccionado_transporte_texto=$("#combo_transporte :selected").text();
     seleccionado_transporte_texto = seleccionado_transporte_texto.replace(/(\r\n|\n|\r)/gm, "");
     var label='<label" >'+seleccionado_transporte_texto+' </label>';

     var texto = label.concat('<div class="item-title" style="width: 100%;"></div>') ;


     $$("#texto_transporte").html(texto);*/
