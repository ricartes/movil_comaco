...
function imprimir_guia(){
	...
	/*DATOS_cambiar_estado_gde(id_gde,estado, function(result) {
		DATOS_asigna_folio_gde(id_gde, function(resul1) {
			if(tipo_volumen==2){
			DATOS_cambia_estado_gdep_pulpable(id_gde,estado, function(result2) {

				DATOS_asigna_folio_gde_pulpable(id_gde, function(result3) {
					app.dialog.alert("Guia impresa correctamente","GFE", function () {
				...
				DATOS_cambia_estado_gdep_aserrable(id_gde,estado, function(result2) {
					DATOS_asigna_folio_gde_aserrable(id_gde, function(result3) {
						app.dialog.alert("Guia impresa correctamente","GFE", function () {
